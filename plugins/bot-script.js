...
let res = await fetch('https://github.com/Jostin207/GokuBot-MD-')
...
await conn.sendUrl(m.chat, git, m, { externalAdReply: { mediaType: 1, renderLargerThumbnail: true, thumbnail: imagen2, thumbnailUrl: imagen1, title: '\t\t\t\t\t\t᭡͡ᩬ✨𝐆𝐎𝐊𝐔𝐁𝐎𝐓-𝐌𝐃-✨✩̣̣̣̣̣ͯ', }})
