...
switch (true) {   
case isCommand7:
if (!text) return conn.reply(m.chat, `[❗𝐈𝐍𝐅𝐎❗] *Debe ingresar un enlace de facebook*\n\nEjemplo, !fb https://fb.watch/kAOXy3wf2L/?mibextid=Nif5oz`, m, fake, )
if (!args[0].match(/www.facebook.com|fb.watch|web.facebook.com|business.facebook.com|video.fb.com/g)) return conn.reply(m.chat, '[❗𝐈𝐍𝐅𝐎❗] *No es un enlace válido, ingrese uno válido*', m, fake, )
